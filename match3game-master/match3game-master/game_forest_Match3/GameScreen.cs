...
namespace game_forest_Match3
{
    public partial class GameScreen : Form
    {
        ...
        private void GameScreen_Load(object sender, EventArgs e)
        {
            ...
            m_game = new Game(fieldSize, fieldSize, Enum.GetValues(typeof(ElementType)).Length);
        ...
        {
            m_active = false;
            MessageBox.Show("The game is over. Your score is " + m_game.GetScore().ToString(), "Game over", MessageBoxButtons.OK);
            Close();
        }
